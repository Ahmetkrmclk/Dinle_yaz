    ...
    public partial class i_o : Form
    {
        ...
        public void Listele()
        {
            try
            {
                ...
                {
                    sqlconnect.Open();
                    string Select = "Select * From ing_orta Order by skor desc";
        ...
        private void i_o_Load(object sender, EventArgs e)
        {
            ...
            textBox1.Text = "Announce";
            textBox2.Text = "Apologise";
            textBox3.Text = "Dream";
            textBox4.Text = "Follow";
            textBox5.Text = "Grandfather";
            textBox6.Text = "Ignore";
            textBox7.Text = "Offer";
            textBox8.Text = "Sing";
            textBox9.Text = "Sister";
            textBox10.Text = "Suppose";
            textBox11.Text = "Swim";
            textBox12.Text = "Tranport";
            textBox13.Text = "Twist";
            textBox14.Text = "Unite";
            textBox15.Text = "Walk";
        ...
        {
            axWindowsMediaPlayer1.URL = "İngilizce\\Orta\\Announce.mp3";
        }

        private void button4_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer2.URL = "İngilizce\\Orta\\Apologise.mp3";
        }

        private void button6_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer3.URL = "İngilizce\\Orta\\Dream.mp3";
        }

        private void button8_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer4.URL = "İngilizce\\Orta\\Follow.mp3";
        }

        private void button10_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer5.URL = "İngilizce\\Orta\\Grandfather.mp3";
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        MySqlDataReader dr;
                        MySqlCommand sqlcommad = new MySqlCommand("Select * From kelimeler_io where kelimeler=@km AND yazilisi=@yzl", sqlconnect);
        ...
        {
            axWindowsMediaPlayer6.URL = "İngilizce\\Orta\\Ignore.mp3";
        }

        private void button15_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer7.URL = "İngilizce\\Orta\\Offer.mp3";
        }

        private void button17_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer8.URL = "İngilizce\\Orta\\Sing.mp3";
        }

        private void button19_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer9.URL = "İngilizce\\Orta\\Sister.mp3";
        }

        private void button21_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer10.URL = "İngilizce\\Orta\\Suppose.mp3";
        }

        private void button24_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer11.URL = "İngilizce\\Orta\\Swim.mp3";
        }

        private void button26_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer12.URL = "İngilizce\\Orta\\Tranport.mp3";
        }

        private void button28_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer13.URL = "İngilizce\\Orta\\Twist.mp3";
        }

        private void button30_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer14.URL = "İngilizce\\Orta\\Unite.mp3";
        }

        private void button32_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer15.URL = "İngilizce\\Orta\\Walk.mp3";   
        }
        ...
        private void button33_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        sqlconnect.Open();//Bağlantıyı açtık
                        MySqlCommand sqlcommad = new MySqlCommand("insert into ing_orta (isim,skor) values (@i,@s)", sqlconnect);
        ...
        private void i_o_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
