...
{
    public partial class Alm_z : Form
    {
        public Alm_z()
        {
            InitializeComponent();
        ...
        public void Listele()
        {
            try
            {
                ...
                {
                    sqlconnect.Open();
                    string Select = "Select * From alm_zor Order by skor desc";
        ...
        private void Alm_z_Load(object sender, EventArgs e)
        {
            ...
            textBox1.Text = "auftauchen";
            textBox2.Text = "augenblicklich";
            textBox3.Text = "befestigt";
            textBox4.Text = "bezüglich";
            textBox5.Text = "das Chaos";
            textBox6.Text = "der verbale Übergriff";
            textBox7.Text = "ehrenamtlich";
            textBox8.Text = "eingeschnappt sein";
            textBox9.Text = "gewaltigt";
            textBox10.Text = "herunterstufen";
            textBox11.Text = "insofern";
            textBox12.Text = "je nach Bedarf";
            textBox13.Text = "kontaktieren";
            textBox14.Text = "lagern";
            textBox15.Text = "scheitern";
            ...
            else
            {
                try
                {
                    if (sqlconnect.State == ConnectionState.Closed)//Bağlantı kapalı ise
                    {
                        ...
                        MySqlCommand sqlcommad = new MySqlCommand("insert into alm_zor (isim,skor) values (@i,@s)", sqlconnect);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        MySqlDataReader dr;
                        MySqlCommand sqlcommad = new MySqlCommand("Select * From kelimeler_az where kelimeler=@km AND yazilisi=@yzl", sqlconnect);
        ...
        {
            axWindowsMediaPlayer1.URL = "Almanca\\Zor\\auftauchen.mp3";
        }

        private void button4_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer2.URL = "Almanca\\Zor\\augenblicklich.mp3";
        }

        private void button6_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer3.URL = "Almanca\\Zor\\befestigt.mp3";
        }

        private void button8_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer4.URL = "Almanca\\Zor\\bezüglich.mp3";
        }

        private void button10_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer5.URL = "Almanca\\Zor\\das Chaos.mp3";
        }

        private void button13_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer6.URL = "Almanca\\Zor\\der verbale Übergriff.mp3";
        }

        private void button15_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer7.URL = "Almanca\\Zor\\ehrenamtlich.mp3";
        }

        private void button17_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer8.URL = "Almanca\\Zor\\eingeschnappt sein.mp3";
        }

        private void button19_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer9.URL = "Almanca\\Zor\\gewaltigt.mp3";
        }

        private void button21_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer10.URL = "Almanca\\Zor\\herunterstufen.mp3";
        }

        private void button23_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer11.URL = "Almanca\\Zor\\insofern.mp3";
        }

        private void button25_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer12.URL = "Almanca\\Zor\\je nach Bedarf.mp3";
        }

        private void button27_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer13.URL = "Almanca\\Zor\\kontaktieren.mp3";
        }

        private void button29_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer14.URL = "Almanca\\Zor\\lagern.mp3";
        }

        private void button31_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer15.URL = "Almanca\\Zor\\scheitern.mp3";
        }

        private void Alm_z_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
