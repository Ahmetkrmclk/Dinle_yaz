...
{
    public partial class alm_k : Form
    {
        public alm_k()
        {
            InitializeComponent();
        ...
        public void Listele()
        {
            try
            {
                ...
                {
                    sqlconnect.Open();
                    string Select = "Select * From alm_kolay Order by skor desc";
        ...
        private void alm_k_Load(object sender, EventArgs e)
        {
            ...
            textBox1.Text = "Acht";
            textBox2.Text = "Auf Wiedersehen";
            textBox3.Text = "Aufzug";
            textBox4.Text = "Da drüben";
            textBox5.Text = "Geschieden";
            textBox6.Text = "Hallo";
            textBox7.Text = "Herzlich willkommen";
            textBox8.Text = "Heute Morgen";
            textBox9.Text = "Hinter";
            textBox10.Text = "ich bin türkisch";
            textBox11.Text = "Kurz";
            textBox12.Text = "Nein";
            textBox13.Text = "Nichts zu danken";
            textBox14.Text = "Niederlandisch";
            textBox15.Text = "Verheiratet";
            ...
            else
            {
                try
                {
                    if (sqlconnect.State == ConnectionState.Closed)//Bağlantı kapalı ise
                    {
                        ...
                        MySqlCommand sqlcommad = new MySqlCommand("insert into alm_kolay (isim,skor) values (@i,@s)", sqlconnect);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        MySqlDataReader dr;
                        MySqlCommand sqlcommad = new MySqlCommand("Select * From kelimeler_ak where kelimeler=@km AND yazilisi=@yzl", sqlconnect);
        ...
        {
            axWindowsMediaPlayer15.URL = "Almanca\\Kolay\\Verheiratet.mp3";
        }
        ...
        {
            axWindowsMediaPlayer1.URL = "Almanca\\Kolay\\Acht.mp3";
        }

        private void button4_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer2.URL = "Almanca\\Kolay\\Auf Wiedersehen.mp3";
        }

        private void button6_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer3.URL = "Almanca\\Kolay\\Aufzug.mp3";
        }

        private void button8_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer4.URL = "Almanca\\Kolay\\Da drüben.mp3";
        }

        private void button10_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer5.URL = "Almanca\\Kolay\\Geschieden.mp3";
        }

        private void button13_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer6.URL = "Almanca\\Kolay\\Hallo.mp3";
        }

        private void button15_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer7.URL = "Almanca\\Kolay\\Herzlich willkommen.mp3";
        }

        private void button17_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer8.URL = "Almanca\\Kolay\\Heute Morgen.mp3";
        }

        private void button19_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer9.URL = "Almanca\\Kolay\\Hinter.mp3";
        }

        private void button21_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer10.URL = "Almanca\\Kolay\\ich bin türkisch.mp3";
        }

        private void button23_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer11.URL = "Almanca\\Kolay\\Kurz.mp3";
        }

        private void button25_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer12.URL = "Almanca\\Kolay\\Nein.mp3";
        }

        private void button27_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer13.URL = "Almanca\\Kolay\\Nichts zu danken.mp3";
        }

        private void button29_Click(object sender, EventArgs e)
        {
            axWindowsMediaPlayer14.URL = "Almanca\\Kolay\\Niederlandisch.mp3";
        }

        private void alm_k_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
